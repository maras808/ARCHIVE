...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    buttons: Schema.Attribute.DynamicZone<['buttons.hero-button']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dropdownImages: Schema.Attribute.DynamicZone<
      ['custom-images.dropdown-image']
    > &
      Schema.Attribute.SetMinMax<
        {
          max: 3;
    ...
    subPages: Schema.Attribute.Component<'links.link', true>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSubPageSubPage extends Struct.SingleTypeSchema {
